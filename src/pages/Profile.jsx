...
export default function Profile() {
  ...
  return (
    <div style={{ animation: 'fadeInUp 0.5s ease forwards', maxWidth: '540px', width: '100%', overflowX: 'hidden' }}>
      ...
      {/* Card perfil */}
      <div style={{ background: 'rgba(13,27,42,0.9)', border: '1px solid rgba(0,212,255,0.15)', borderRadius: '16px', overflow: 'hidden', marginBottom: '14px' }}>
